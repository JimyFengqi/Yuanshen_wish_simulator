...
element_dict = {'莫娜': '水', '芭芭拉': '水', '行秋': '水', '坎蒂丝': '水', '达达利亚': '水', '珊瑚宫心海': '水',
                '神里绫人': '水', '夜兰': '水', '妮露': '水', '那维莱特': '水', '芙宁娜': '水','迪卢克': '火', '迪希雅': '火', '安柏': '火',
                '班尼特': '火', '辛焱': '火', '烟绯': '火', '托马': '火', '香菱': '火', '可莉': '火', '胡桃': '火',
                '宵宫': '火', '林尼': '火', '七七': '冰', '凯亚': '冰', '重云': '冰', '迪奥娜': '冰', '罗莎莉亚': '冰',
                '莱依拉': '冰', '米卡': '冰', '甘雨': '冰', '优菈': '冰', '神里绫华': '冰', '申鹤': '冰','莱欧斯利': '冰', '菲米尼': '冰', '夏洛蒂': '冰','刻晴': '雷',
                '丽莎': '雷', '雷泽': '雷', '北斗': '雷', '菲谢尔': '雷', '九条裟罗': '雷', '久岐忍': '雷',
                '多莉': '雷', '雷电将军': '雷', '八重神子': '雷', '赛诺': '雷', '夏沃蕾': '雷', '琴': '风', '砂糖': '风', '早柚': '风',
                '珐露珊': '风', '鹿野院平藏': '风', '温迪': '风', '魈': '风', '枫原万叶': '风', '流浪者': '风',
                '琳妮特': '风', '凝光': '岩', '诺艾尔': '岩', '五郎': '岩', '云堇': '岩', '钟离': '岩', '阿贝多': '岩',
                '荒泷一斗': '岩', '娜维娅': '岩', '提纳里': '草', '柯莱': '草', '卡维': '草', '瑶瑶': '草', '纳西妲': '草',
                ...
                '息灾': '长柄武器', '赤沙之杖': '长柄武器',
                '最初的大魔术': '弓','万世流涌大典': '法器','金流监督': '法器','裁断': '双手剑', '金流监督': '法器','静水流涌之辉': '单手剑'  }
